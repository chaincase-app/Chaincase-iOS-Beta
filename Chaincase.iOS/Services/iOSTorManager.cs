    ...
    public class iOSTorManager : ITorManager
    {
        ...
        private TORConfiguration torBaseConf
        {
            get
            {
                ...
                {
                    Logger.LogWarning($"Could not set CompleteUntilFirstUserAuthentication Protection at {dataDir}");
                }
                configuration.DataDirectory = new NSUrl(dataDir);
        ...
        //private static NSUrl GetDataDirectory()
        //{
        //    NSFileManager.DefaultManager.GetUrls(NSSearchPathDirectory.CachesDirectory, NSSearchPathDomain.User).First().Path
        //}
